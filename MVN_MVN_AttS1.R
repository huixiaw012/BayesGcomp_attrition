...
invisible(parallel::clusterEvalQ(cl, {
  ...
  library(locfit)
  library(rBeta2009)
  source("/home/h/huixiaw/huixiaw/GcomGSBART_simulation/MAR_countries/nonlinear/gamma309016_MVNBeta/MVN_MVN_AttS/sim_data_nonlin.R")
...
write.table(results,
            file =  paste0("/home/h/huixiaw/huixiaw/GcomGSBART_simulation/MAR_countries/nonlinear/gamma309016_MVNBeta/MVN_MVN_AttS/outputs/MVN_MVN_", n_attr ,"Miss","_Chain",
